...
- By now, [modern-cpp-kafka](https://github.com/morganstanley/modern-cpp-kafka) is compatible with [librdkafka v1.9.1](https://github.com/edenhill/librdkafka/releases/tag/v1.9.1).
